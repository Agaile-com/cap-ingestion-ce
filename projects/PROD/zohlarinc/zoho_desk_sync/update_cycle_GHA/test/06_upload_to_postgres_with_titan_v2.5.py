...
DB_HOST = '127.0.0.1'  # Use the local forwarded address
...
def check_env_vars():
    required_vars = ['S3_BUCKET_NAME', 'TENANT_NAME', 'POSTGRESQL_DB_NAME', 'POSTGRESQL_DB_USER', 'POSTGRESQL_DB_PASSWORD', 'POSTGRESQL_DB_PORT', 'AWS_REGION']
...
def process_documents_and_upload_to_pg(docs, embed, engine):
    ...
    try:
        ...
        PGVector.from_embeddings(
            ...
            texts=all_texts_for_embeddings,
