...
def upload_file_to_s3(file_path, bucket, object_name=None):
    ...
    if object_name is None:
        ...
        object_name = f"cat-be/zohodesk-data/synced/vectordata_{timestamp}.json"
...
def main():
    ...
    file_path = os.path.join(BASE_DIR, 'zoho_desk_sync/initial_sync/data/08_synced_vectordata.json')
